...
<?php if (($header_menu_items_count > 0) || ($header_features_menu_items_count > 0)) : ?>
  ...
  <?php if ($header_menu_items_count > 0) : ?>
    ...
    <li class="menu-main-item">
      <!-- MENU MAIN ITEM LINK -->
      <a class="menu-main-item-link" href="<?php echo esc_url($args['header_menu_items'][0]['link']); ?>">
      <?php
  ...
  ?>
    ...
    <li class="menu-main-item">
      <!-- MENU MAIN ITEM LINK -->
      <a class="menu-main-item-link" href="<?php echo esc_url($header_menu_item['link']); ?>">
      <?php
