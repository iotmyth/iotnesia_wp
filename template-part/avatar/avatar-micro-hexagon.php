<?php
/**
 * Vikinger Template Part - Avatar Micro
 * 
 * @package Vikinger
 * @since 1.0.0
...
<!-- USER AVATAR -->
<?php if ($linked) : ?>
<a class="user-avatar micro no-stats <?php echo esc_attr($modifiers_classes); ?> <?php echo esc_attr($no_border_classes); ?>" href="<?php echo esc_url($args['user']['link']) ?>">
<?php else : ?>
<div class="user-avatar micro no-stats <?php echo esc_attr($modifiers_classes); ?> <?php echo esc_attr($no_border_classes); ?>">
<?php endif; ?>
<?php if (!$no_border) : ?>
  <!-- USER AVATAR BORDER -->
...
<?php endif; ?>
  ...
  <div class="user-avatar-content">
    <!-- HEXAGON -->
    <div class="hexagon-image-18-20" data-src="<?php echo esc_url($args['user']['avatar_url']); ?>"></div>
    <!-- /HEXAGON -->
  </div>
  <!-- /USER AVATAR CONTENT -->
<?php if ($linked) : ?>
