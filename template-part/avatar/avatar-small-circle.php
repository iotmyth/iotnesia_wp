<?php
/**
 * Vikinger Template Part - Avatar Small Circle
 * 
 * @package Vikinger
 * @since 1.3.6
...
<!-- USER AVATAR CIRCLE -->
<?php if ($linked) : ?>
<a class="user-avatar-circle small <?php echo esc_attr($no_stats_classes); ?> <?php echo esc_attr($modifiers_classes); ?> <?php echo esc_attr($no_border_classes); ?>" href="<?php echo esc_url($args['user']['link']) ?>">
<?php else : ?>
<div class="user-avatar-circle small <?php echo esc_attr($no_stats_classes); ?> <?php echo esc_attr($modifiers_classes); ?> <?php echo esc_attr($no_border_classes); ?>">
<?php endif; ?>
...
<?php if (!$no_stats) : ?>
  ...
  <div class="user-avatar-circle-progress user-avatar-circle-progress-small" data-scalestop="<?php echo esc_attr($current_rank_ratio); ?>"></div>
  <!-- /USER AVATAR CIRCLE PROGRESS -->
