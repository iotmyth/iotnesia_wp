...
function vikinger_translation_get() {
  return [
     ...
     * Filterable List
     */
    'post_no_results_title'       => esc_html__('No posts found', 'vikinger'),
    'post_no_results_text'        => esc_html__('Please create some posts or try with another filter!', 'vikinger'),
    'member_no_results_title'     => esc_html__('No members found', 'vikinger'),
    'member_no_results_text'      => esc_html__('Please try with another filter!', 'vikinger'),
    'group_no_results_title'      => esc_html__('No groups found', 'vikinger'),
    'group_no_results_text'       => esc_html__('Please try with another filter!', 'vikinger'),
    'activity_no_results_title'   => esc_html__('No posts found', 'vikinger'),
    'activity_no_results_text'    => esc_html__('Please create some posts or try with another filter!', 'vikinger'),
