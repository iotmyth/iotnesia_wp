      ...
      <div class="vikinger-forum-topic-form-wrap">
        ...
        <legend><?php esc_html_e( 'Rename', 'bbpress' ); ?></legend>
          ...
          <form id="rename_tag" name="rename_tag" method="post">
            ...
            <div class="bbp-submit-wrapper">
              <button type="submit" class="button secondary submit"><?php esc_attr_e( 'Update', 'bbpress' ); ?></button>
        ...
        <legend><?php esc_html_e( 'Merge', 'bbpress' ); ?></legend>
          ...
          <form id="merge_tag" name="merge_tag" method="post">
            ...
            <div class="bbp-submit-wrapper">
              <button type="submit" class="button secondary submit" onclick="return confirm('<?php echo esc_js( sprintf( esc_html__( 'Are you sure you want to merge the "%s" tag into the tag you specified?', 'bbpress' ), bbp_get_topic_tag_name() ) ); ?>');"><?php esc_attr_e( 'Merge', 'bbpress' ); ?></button>
          ...
          <legend><?php esc_html_e( 'Delete', 'bbpress' ); ?></legend>
            ...
            <form id="delete_tag" name="delete_tag" method="post">
              ...
              <div class="bbp-submit-wrapper">
                <button type="submit" class="button secondary submit" onclick="return confirm('<?php echo esc_js( sprintf( esc_html__( 'Are you sure you want to delete the "%s" tag? This is permanent and cannot be undone.', 'bbpress' ), bbp_get_topic_tag_name() ) ); ?>');"><?php esc_attr_e( 'Delete', 'bbpress' ); ?></button>
